  ...
  return (
    <div>
      <ul className="flex justify-around items-center mb-[24px]">
        <li>
          <p className="font-[400] text-[20px] leading-[22px] text-[#00000099]">
            Product Details
          </p>
        </li>
        <li>
      ...
      <div className="flex justify-between items-center">
        <p className="font-[700] text-[24px] leading-[32.4px]">
          All Reviews{" "}
          <span className="font-[400] text-[16px] leading-[22px]">
            ({comments?.length || 0})
          </span>
        </p>
      ...
      <div className="comment_detail mt-8  flex flex-wrap justify-between gap-[40px] mb-[36px]">
        {comments?.map((comment) => (
          <div
            key={comment.id}
            className="border rounded-[20px] flex items-start px-[32px] py-[28px]"
          >
            <div className="li w-[600px] flex flex-col gap-[18px]">
              <div className="flex items-center">
                <Rating
                  name="half-rating"
                  defaultValue={comment.grade}
                  precision={0.1}
                />
